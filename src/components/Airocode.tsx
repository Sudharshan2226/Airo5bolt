...
const Airoctf = () => {
  ...
  // Hosts data
  const hosts = [
    { name: "SARUMATHI BHUVANIKA S", twitter: "https://www.linkedin.com/in/sarumathi-%20bhuvanika-s-027111292/" },
    { name: "Rakuram SV", twitter: "https://www.linkedin.com/in/rakuram-sv-127107299/" },
    { name: "MV PRIYADHARSHINI", twitter: "https://www.linkedin.com/in/priyadharshini-manivasahan-31a930292?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" },
    { name: "Deepak R", twitter: "https://www.linkedin.com/in/deepak-r-57603b283?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" },
    { name: "Swathy S", twitter: "https://www.linkedin.com/in/swathy-singaravelu-0585ba290?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" }
  ];
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            {/* <div className="relative">
              ...
              <div className="relative aspect-square rounded-2xl overflow-hidden airo-cover-image">
                <div className="w-full h-full flex items-center justify-center">
                  <img
                    src="/events/gwen.jpg"
                    alt="AIRO 5.0 Across Dimensions CTF"
            ...
            <div className="hidden lg:block space-y-6 mt-8">
              ...
              <div className="flex justify-center">
                <span className="inline-flex items-center px-3 py-1 bg-red-600/20 text-red-400 rounded-full text-sm">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-8">
              ...
              <h1 className="text-5xl font-bold text-white mb-6">AIRO 5.0 | Across Dimensions [CTF]</h1>
            ...
            <div className="glass-card rounded-xl p-6 mb-8">
              ...
              <div className="prose prose-invert max-w-none">
                <h1 className="text-2xl font-bold text-white mb-4">🏴 AIRO 5.0 | Across Dimensions [CTF]</h1>
                
                <p className="text-gray-300 mb-4">
                  <strong>Hack Your Way Through Multiple Dimensions!</strong>
                </p>
                
                <p className="text-gray-300 mb-6">
                  Join us for an exciting Capture The Flag (CTF) competition as part of AIRO 5.0! This cybersecurity challenge will test your skills across multiple categories including Web Security, Forensics, Cryptography, Reverse Engineering, and more. Work in teams to solve challenges, capture flags, and climb the leaderboard in this thrilling 2-hour competition.
                </p>
                ...
                <div className="space-y-4 mb-6">
                  <div className="bg-blue-900/20 border border-blue-700/30 rounded-lg p-4">
                    <h3 className="text-lg font-bold text-blue-400 mb-2">Preliminary Round (Online)</h3>
                    <ul className="text-gray-300 space-y-1 ml-4">
                      <li>• <strong>Mode:</strong> Online Quiz</li>
                      <li>• <strong>Purpose:</strong> To filter and identify the top-performing teams</li>
                      <li>• <strong>Selection:</strong> The Top 10 teams will qualify for Round 2</li>
                    </ul>
                  </div>

                  <div className="bg-red-900/20 border border-red-700/30 rounded-lg p-4">
                    <h3 className="text-lg font-bold text-red-400 mb-2">Round 2 (Offline)</h3>
                    <ul className="text-gray-300 space-y-1 ml-4">
                      <li>• <strong>Mode:</strong> On-campus</li>
                      <li>• <strong>Qualified Teams:</strong> 10 teams selected from the Preliminary Round</li>
                      <li>• <strong>Duration:</strong> 2 hours</li>
                      <li>• <strong>Platform:</strong> CTFd</li>
                      <li>• <strong>Team Size:</strong> 2–4 members per team</li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="space-y-3 mb-6">
                  <div className="bg-gray-800/50 rounded-lg p-3">
                    <h3 className="text-green-400 font-medium mb-1">First 10 minutes – Introduction & Briefing</h3>
                    <ul className="text-gray-300 space-y-1 text-sm ml-4">
                      <li>• Welcome and explanation of event rules</li>
                      <li>• Overview of scoring system and challenge categories</li>
                      <li>• Walkthrough on how to attempt and submit challenges</li>
                    </ul>
                  </div>

                  <div className="bg-gray-800/50 rounded-lg p-3">
                    <h3 className="text-yellow-400 font-medium mb-1">Main Challenge – Solving the CTF</h3>
                    <ul className="text-gray-300 space-y-1 text-sm ml-4">
                      <li>• Teams work on challenges across categories: Web, Forensics, Cryptography, Reverse Engineering, and Miscellaneous</li>
                      <li>• Flags are submitted through the platform to earn points</li>
                    </ul>
                  </div>

                  <div className="bg-gray-800/50 rounded-lg p-3">
                    <h3 className="text-red-400 font-medium mb-1">Final 5 minutes – Wrap-up & Score Freeze</h3>
                    <ul className="text-gray-300 space-y-1 text-sm ml-4">
                      <li>• Submissions close</li>
                      <li>• Scores are verified and locked before results announcement</li>
                    </ul>
                  </div>
                </div>
                ...
                <ul className="text-gray-300 space-y-1 mb-6">
                  <li>• <strong>Score:</strong> Based on the total number of valid flags captured</li>
                  <li>• <strong>Time:</strong> In case of a tie, the team that solved challenges earlier will rank higher</li>
                  <li>• <strong>Teamwork & Ethics:</strong> Misuse of systems, plagiarism, or unfair practices will lead to disqualification</li>
                </ul>
                ...
                <ul className="text-gray-300 space-y-1 mb-6">
                  <li>• <strong>Team Size:</strong> 2–4 members per team</li>
                  <li>• <strong>Original Work:</strong> All solutions must be the team's own effort. Flag sharing between teams is strictly prohibited</li>
                  <li>• <strong>No External Assistance:</strong> Use of outside help, pre-solved writeups, or unauthorized tools is not allowed</li>
                  <li>• <strong>Fair Play:</strong> Any violation of the rules will result in disqualification</li>
                </ul>
                ...
                <p className="text-gray-300 mb-4">
                  After lunch, all participants gather at Apple Hall where the winners are announced and prizes distributed.
                </p>
                <ul className="text-gray-300 space-y-1 mb-6">
                  <li>• Cash prizes for top 3 teams</li>
                  <li>• Certificates for all participants</li>
                  <li>• Special recognition for best team collaboration</li>
              ...
              <div className="relative rounded-xl overflow-hidden">
                <div className="lg:flex items-stretch overflow-hidden">
                  <div className="lg:w-1/3 bg-gray-800/50 p-6 z-10 text-white">
                    <h3 className="text-lg font-medium mb-3 text-red-400">Venue Details</h3>
                    <div className="space-y-2 text-gray-300">
                      <p className="font-medium">INTEL Lab - A Block, First Floor</p>
                    ...
                    <div className="mt-6">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center justify-center w-full py-3 px-4 rounded-lg bg-gradient-to-r from-red-500 to-purple-600 hover:from-red-600 hover:to-purple-700 text-white font-medium transition-all duration-300"
                      >
      ...
      <footer className="relative z-10 bg-gray-900/50 backdrop-blur-sm border-t border-gray-800 mt-16">
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center">
            <p className="text-sm text-gray-400">
              Hack your way through multiple dimensions at AIRO 5.0 – CTF Challenge!
            </p>
          </div>
        </div>
      </footer>
