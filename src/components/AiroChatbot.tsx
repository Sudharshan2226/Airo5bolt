        ...
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            {/* <div className="relative">
              ...
              <div className="relative aspect-square rounded-2xl overflow-hidden airo-cover-image">
                <div className="w-full h-full flex items-center justify-center">
                  <img
                    src="/events/gwen.jpg"
                    alt="AIRO 5.0 AI Chatbot Challenge"
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-8">
              ...
              <h1 className="text-5xl font-bold text-white mb-6">AIRO 5.0 | AI Chatbot Challenge</h1>
            ...
            <div className="glass-card rounded-xl p-6 mb-8">
              ...
              <div className="prose prose-invert max-w-none">
                <h1 className="text-2xl font-bold text-white mb-4">🤖 AIRO 5.0 | AI Chatbot Challenge</h1>
                
                <p className="text-gray-300 mb-4">
                  <strong>Build the Future of Conversational AI!</strong>
                </p>
                
                <p className="text-gray-300 mb-6">
                  Join us for an exciting AI Chatbot Challenge as part of AIRO 5.0! This fast-paced 2-hour competition will challenge your creativity, problem-solving skills, and ability to build functional AI chatbots using modern AI tools and APIs. Whether you're an AI enthusiast or just starting your journey in conversational AI, this event offers the perfect platform to showcase your skills.
                </p>
                ...
                <ul className="text-gray-300 space-y-2 mb-6">
                  <li><strong>11:00 – 11:10 AM:</strong> Theme Reveal & Rules Briefing</li>
                  <li><strong>11:10 – 12:10 PM:</strong> Bot Development Time</li>
                  <li><strong>12:10 – 1:00 PM:</strong> Demo & Evaluation</li>
                </ul>
                ...
                <ul className="text-gray-300 space-y-1 mb-6">
                  ...
                  <li>• <strong>Team Size:</strong> Maximum 3 members per team</li>
                  <li>• <strong>Themes:</strong> Choose from 4 exciting chatbot themes</li>
                  <li>• <strong>Tools Allowed:</strong> Any AI tool (ChatGPT, Claude, low-code chatbot builders)</li>
                  <li>• <strong>Deliverable:</strong> Working chatbot demo with required features</li>
                </ul>
                ...
                <ul className="text-gray-300 space-y-1 mb-6">
                  <li>• <strong>Functionality (40%):</strong> Meets minimum requirements</li>
                  <li>• <strong>Creativity (20%):</strong> Unique approach or added features</li>
                  <li>• <strong>User Experience (20%):</strong> Easy to use, clear interface</li>
                  <li>• <strong>Presentation/Demo (20%):</strong> How well the chatbot is showcased</li>
                </ul>
                ...
                <ul className="text-gray-300 space-y-1 mb-6">
                  <li>• Use any AI tool (ChatGPT, Claude, low-code chatbot builders)</li>
                  <li>• Teams of max 3 participants</li>
                  <li>• Must demonstrate live working chatbot within 2 hours</li>
                  <li>• Plagiarism or pre-built bots are not allowed</li>
                  <li>• All chatbots must be original and built during the event</li>
                  <li>• Teams must present their final chatbot within the time limit</li>
                </ul>
                ...
                <p className="text-gray-300 mb-4">
                  After the demos, all participants gather at Apple Hall where the winners are announced and prizes are distributed.
                </p>
                <ul className="text-gray-300 space-y-1 mb-6">
                  <li>• Cash prizes for top 3 teams</li>
                  <li>• Certificates for all participants</li>
                  <li>• Special recognition for most innovative chatbot</li>
                  <li>• Networking opportunities with AI industry professionals</li>
                </ul>
              ...
              <div className="relative rounded-xl overflow-hidden">
                <div className="lg:flex items-stretch overflow-hidden">
                  <div className="lg:w-1/3 bg-gray-800/50 p-6 z-10 text-white">
                    <h3 className="text-lg font-medium mb-3 text-blue-400">Venue Details</h3>
                    ...
                    <div className="mt-6">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center justify-center w-full py-3 px-4 rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-medium transition-all duration-300"
                      >
      ...
      <footer className="relative z-10 bg-gray-900/50 backdrop-blur-sm border-t border-gray-800 mt-16">
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center">
            <p className="text-sm text-gray-400">
              Build the future of conversational AI at AIRO 5.0 – AI Chatbot Challenge!
            </p>
          </div>
        </div>
      </footer>
