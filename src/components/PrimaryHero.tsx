    ...
    <>
      <header className="section default-header full-height all-devices home-header" data-theme-section="dark" data-scroll-section data-vimeo-status-both-loaded="false">
        <div className="single-vimeo-background" id="vimeo-background-index-custom-1" data-scroll data-scroll-speed="-4" data-scroll-position="top" data-vimeo-background-target data-vimeo-status-sync="false" data-vimeo-status-activated="false" data-vimeo-status-loaded="false" data-vimeo-status-muted="true" style={{ }}>
          <iframe src="https://player.vimeo.com/video/800912034?api=1&background=1&autoplay=1&loop=1&autopause=0" width="640" height="360" frameBorder="0" allow="autoplay; encrypted-media" allowFullScreen></iframe>
        ...
        <div className="container">
          <div className="row">
            <div className="col">
              <h1 className="split-chars animate-h1 desktop">HACKTRONIX 1.0</h1>
              <h1 className="split-chars animate-h1 mobile">HACKTRONIX 1.0</h1>
            </div>
          </div>
        </div>
      ...
      <section className="section section-intro section-intro-home" id="section-intro" data-theme-section="dark" data-scroll-section>
        <div className="container">
          <div className="row split">
            <div className="col">
              <h3><span data-cursor-gif-target="file://P3ZdDG3Y6gHE4VQQ">Welcome to HACKTRONIX 1.0</span></h3>
            </div>
          </div>
          <div className="row split">
            <div className="col">
            ...
            <div className="col">
              <div className="col-row">
                <h4>The ultimate 24-hour hackathon experience at AIRO College. Join innovative minds from across the region to code, create, and compete in cutting-edge technology challenges. With our signature style of innovation and collaboration, we create solutions that are as impactful as they are creative. Team up with us to push the boundaries of technology and innovation.</h4>
              </div>
